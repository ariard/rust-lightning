//! The logic to build and bump on-chain transactions.
...
/// OnchainTxManager which keeps track of a number of claim requests and use a basic RBF.
#[derive(Clone)]
...
impl OnchainTxHandler {
	...
	fn generate_claim_tx(&self, height: u32, cached_claim_datas: &ClaimTxBumpMaterial, fee_estimator: &FeeEstimator) -> Option<(u32, u64, Transaction)> {
	...
	pub(crate) fn block_disconnected(&mut self, height: u32, broadcaster: &BroadcasterInterface, fee_estimator: &FeeEstimator) {
